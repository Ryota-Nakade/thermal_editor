...
double k3 = 1.65216912e-05;
    ...
    DistortionCorrect()//コンストラクタ
        : it(nh){
            ...
            cv::initUndistortRectifyMap(camMat, distCoef, cv::noArray(), cv::noArray(), cv::Size(707, 530), CV_16SC2, map1, map2);//歪み補正マップの算出．cv::remap()とペアで使用．PI450はcv::Sizeを(382,288)に，PI640は(640,480)に変えること
            //pi640 860, 530
        }
